...
const func = {
    ...
    PHex: '(hexnum="A")\r\n Returns a conversion of a hex number to a Binary pattern ',
    ...
    gen: '(genre="techno", role="bass", evolve=1, idx=None, seed=None)\r\n Melody pattern generator. Returns degree list with .sus and .amp\n Genres: techno, gesaffelstein, minimal, metal, dnb, dub, ebm, acid, ambient, industrial, idm\n Roles: bass, lead, pad, arp, stab',
    pgen: '(genre="techno", role="bass", evolve=1, idx=None, seed=None)\r\n Player method: sets degree + sus + amp.\n .pgen("techno", "bass") .pgen("metal", "lead", 8) .pgen("gesaffelstein", "bass", seed=42)\n Genres: techno, gesaffelstein, minimal, metal, dnb, dub, ebm, acid, ambient, industrial, idm\n Roles: bass, lead, pad, arp, stab',
    gp: '(code)\r\n Named melody pattern. {genre}{role}{number}: tb1=techno bass, gl3=gesaffelstein lead, ml1=metal lead',
    ...
    fw: '(16, 1, 7)\r\nF walk: PWalk bounded random walk, always >= 0. fw() fw(8) fw(8, 1, 7). n=length, a=step size, b=max.',
