...
j3 >> lbass(([0, 0, 1, 2, 0, [-1, 3, 7], [2, 3, 7]], 0), sus=(P*[1/2, 1/4, 1], 0.5), scale=Scale.chromatic, dur=var([1/4, 1/2, 1/2, 1/4, 1, 1/2, 1/2, 1]), oct=PStep(11, [5, 5, 6], [4, [6.01, 4.95]]),rate=P*[2, 1, 0.5, 4], formant=var([0, 0.2, 0.1, 1, 0.1, 0.1, 0.1, 4], [7, 3, 4, 2]), dist2=1, mverb=0.1,amp=var([1, 0.5, 1], [3, 4, 1])).unison(2)
