...
fx.add("leftDelay = DelayL.ar(LocalIn.ar(1) + osc[0], maxdelaytime: 2*sus, delaytime: (delaytime * modulation), decaytime: sus*2)")
fx.add("rightDelay = DelayL.ar(LocalIn.ar(1) + osc[1], maxdelaytime: 2*sus, delaytime: (delaytime * modulation * (1 + (ebstereo * 0.1))), decaytime: sus*2)")
