...
a6 >> play("x ", dur=8, lpf=400, room2=0, damp2=0, revus=8, shape=0.1, echo=0.05, echotime=8)
...
a9 >> play("p.", dur=1/4, leg=12,lpf=linvar([800, 1400], 32), sample=0, room2=0.1, damp2=0, revus=2, shape=0, amp=[0.5, 0.7], echo=[0.05, 0.25], echotime=x3.dur).often("stutter", 2, rate=2, amp=0.5, dur=1/2).sometimes("stutter", 16)
a7.stop()

~a1 >> play("u", dur=4, leg=12, echo=0.5)
~a2 >> play("x ", dur=128, lpf=3200, room2=1, damp2=0, revus=8, shape=0.0, echo=0.05, echotime=8)
