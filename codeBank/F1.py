...
f5 >> play("<[--]><..U(..[UU])><..o.><.:>", amp=1, valad=expvar([0,0,6000], [64,64,0]), valadr=0.3, valadd=5, valadt=var([0, 2],[48, 16]), valadc=0.3, sample=4, room2=1, mix2=0.3, revsus=0.5, revatk=-0.3).sometimes("stutter", 4)
f6 >> play("..C.", amp=1)
