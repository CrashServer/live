...
l2 >> loop("wa8", dur=32, sample=PRand(8), formant=2, amp=PBin(8), lpf=3200)
~l4 >> play("{hipP}",dur=(4, 3, PRand([1, 4])), rate=(4, -3, PRand(-4, 4)), feed=0.0, dubd=0.0, sample=(0,[2, 0, 3], PRand(8))).unison(4)
