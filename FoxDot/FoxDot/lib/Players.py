...
from .Settings import SamplePlayer, LoopPlayer, WaveTablePlayer
...
class Player(Repeatable):
    ...
    def new_message_header(self, event, **kwargs):
        ...
        # CrashMod
        elif self.synthdef == WaveTablePlayer:
            degree = kwargs.get("degree", event["degree"])
            ...
            message.update({'freq':  freq, 'midinote': midinote, 'buf': buf, 'bank': bank} )
            # Updater player key
