## thehumblepath 132
# todo
b3 >> prodrums([0, 3, 7, 10, 12, 7], voice=4, dur=PDur(3, 8), layer1_amp=0.5, layer2_amp=0.4, layer3_amp=0.4, body_tone=var([3500, 3000, 4200], [6, 1, 1]), harmonic=1.5, fm_amount=0.4, fm_ratio=2.5, waveform=var([1, 6], 12), texture=19, decay=var([0.4, 0.2], 8), attack=0.1, mid_sat=0.8, high_sat=1.0, amp=0.55, scale=Scale.minor, oct=6, pan=PSine(8) * 0.3)
...
b5 >> prodrums([12, 10, 7, 5], voice=4, dur=var([0.25, 0.5], [3, 1]), layer1_amp=0.55, layer2_amp=1.1, layer3_amp=0.56, body_tone=var([3100, 2800, 200], 4), harmonic=1.8, fm_amount=1.35, waveform=6, texture=var([2, 0], 8), decay=0.25, attack=0.01, mid_gain=0.65,  high_gain=0.65, amp=0.5, scale=Scale.minor, oct=6).every(8, 'reverse')
p4 >> arpy([12, 15, 17, 19], dur=0.25, amp=0.0345, oct=6, sus=0.2, lpf=linvar([3000, 5000], 16), room=0.3, pan=PSine(12) * 0.5, scale=Scale.minor)
...
p3 >> bass([0, 3, 5, 7], dur=PDur(5, 8), amp=0.9, oct=5, decay=0.3, hpf=200, hpr=0.5, room=0.1, dist2=0.3,scale=Scale.minor).every(8, 'reverse')
...
b7 >> cbass(b6.degree, dur=0.25, follow=4, lpf=1200)
...
p5 >> marimba([7, 5, 3, 0], dur=var([0.5, 1], [3, 1]), amp=0.7, oct=6, decay=0.4, room=0.25, pan=var([-0.3, 0.3], 2), scale=Scale.minor).every(16, 'stutter', 4)
...
b1 >> prodrums([0, 3, 5, var([7, 10], 8)], voice=4, dur=0.5, layer1_amp=0.9, layer2_amp=1.0, layer3_amp=1.0, body_tone=1901, harmonic=2.0, texture=12, fm_amount=0.5, waveform=1, decay=0.4, low_gain=0.4, low_sat=1.2, mid_gain=0.5, lpf=linvar([400, 3000], 16), lpr=0.3, amp=0.8, scale=Scale.minor, oct=(4))
