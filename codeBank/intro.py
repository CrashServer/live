...
a3 >> glitcher(oct=PRand(8), rate=PWhite(1, 128), amp=0.6, dur=PWhite(0.2,4), len=PWhite(1, 16), henA=PWhite(0.01, 4), fmod=0, henB=PWhite(0.1, 0.2), t=P*[2, 4, 6, 8, 32], crush=PRand(16),bits=16, shape=0, mverb=0.6, revsus=c1.dur)
