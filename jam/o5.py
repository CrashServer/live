...
d1 >> dbass([3, 4, 4, 8, 4, 7, 4, 4], scale=Scale.chromatic, dur=1/3, rate=([4, 2, 1, 0.5], 0.1), lpf=1200, hpf=[1200, 400, 300, 600], lpr=0.4, lofi=1).every(5, "stutter", rate=0.25, oct=6)

d2 >> dbass([3, 4, 4, 8, 4, 7, 4, 4], oct=P[5, 6], scale=Scale.chromatic, flanger=[0.7, 0.9, 0.8, 0.7], dur=1/3, echo=1/3).unison(4).sometimes("shuffle").sometimes("amen")
d0 >> supersaw(dur=3, amp=1, oct=4, cut=1/2).stop()
